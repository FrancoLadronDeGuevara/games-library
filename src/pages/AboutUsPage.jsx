...
const AboutUsPage = () => {
  const cardsData = [
    {
      ...
      profileImage:
        "https://avatars.githubusercontent.com/u/221231661?v=4&size=64",
    },
    {
      id: 2,
      title: "Franco Guevara",
      description: "Vicioso, adicto a la cafeína!",
      profileImage: "https://avatars.githubusercontent.com/u/124011487?v=4",
    },
    {
      id: 3,
      title: "Pablo Gerez",
  ...
  return (
    <div className="min-h-screen bg-bg-base">
      <section className="flex items-center justify-center px-6 py-10">
        <div className="max-w-2xl text-center">
          ...
          <p className="text-lg md:text-xl text-text-secondary mb-6 leading-relaxed">
            At Games Atlas, we're passionate about video games and believe every
            player deserves an exceptional experience. Our team is dedicated to
            creating the best platform to discover, share, and enjoy the games
            you love most.
          </p>
      ...
      <section className="px-6 py-8 bg-bg-surface">
        <h2 className="text-4xl font-bold text-text-primary text-center mb-20">
          Our Team
        </h2>
